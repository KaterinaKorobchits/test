...
class PickerDateDialog private constructor(private val builder: Builder) : DatePickerDialog(
    ...
    class Builder(internal val context: Context) {
        ...
        internal var theme: Int = R.style.DatePickerDialogTheme
        ...
        internal fun build(): PickerDateDialog = PickerDateDialog(this)
    }
}