...
class PickerTimeDialog private constructor(private val builder: Builder) : TimePickerDialog(
    ...
    class Builder(internal val context: Context) {
        ...
        internal var theme: Int = R.style.TimePickerDialogTheme
        ...
        internal fun build(): PickerTimeDialog = PickerTimeDialog(this)
    }
}